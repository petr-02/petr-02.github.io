...
function letThereBeSunOnElement (sunElm:HTMLElement) {
 ...
 const blackDistanceAtNoon:number=100;                     // yellow is at ${yellowDistance}%, at noon black is at ${blackDistanceAtNoon}% (eg. 100%), ${blackDistanceAtNoon - yellowDistance}% (eg. 75%) transition from yellow to black, giving room for sun yellow light
 ...
 let blackColorPosition:number= blackDistanceAtNight;      // animation starts at midnight, with sunRise=true
