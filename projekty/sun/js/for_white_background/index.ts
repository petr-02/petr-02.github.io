...
function letThereBeSunOnElement (sunElm:HTMLElement) {
 ...
 const blackDistanceAtNoon:number=40;                      // yellow is at ${yellowDistance}%, at noon black is at ${blackDistanceAtNoon}% (eg. 40%), ${blackDistanceAtNoon - yellowDistance}% (eg. 30%) transition from yellow to black, giving room for sun yellow light
