...
function setInitialStyleForElement(sunElm) {
    ...
    sunElm.style.height = 0.3 * lesserViewportSize + "px";
    sunElm.style.width = 0.3 * lesserViewportSize + "px";
    sunElm.style.position = "absolute";
    sunElm.style.top = 0.05 * lesserViewportSize + "px";
    sunElm.style.right = 0.05 * lesserViewportSize + "px";
}
function letThereBeSunOnElement(sunElm) {
    ...
    const blackDistanceAtNoon = 40; // yellow is at ${yellowDistance}%, at noon black is at ${blackDistanceAtNoon}% (eg. 40%), ${blackDistanceAtNoon - yellowDistance}% (eg. 30%) transition from yellow to black, giving room for sun yellow light
