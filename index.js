...
function setInitialStyle(sunElmContainer) {
    ...
    sunElmContainer.style.height = 0.3 * lesserViewportSize + "px";
    sunElmContainer.style.width = 0.3 * lesserViewportSize + "px";
    sunElmContainer.style.position = "absolute";
    sunElmContainer.style.top = 0.05 * lesserViewportSize + "px";
    sunElmContainer.style.right = 0.05 * lesserViewportSize + "px";
}
