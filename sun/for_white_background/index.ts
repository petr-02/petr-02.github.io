...
function letThereBeSunOnElement (sunElm:HTMLElement) {
 ...
 const blackDistanceAtNoon:number=40;                      // yellow is at ${yellowDistance}%, at noon black is ${blackDistanceAtNoon}% (eg. 40%), ${blackDistanceAtNight - yellowDistance}% (eg. 30%) transition from yellow to black, giving room for sun yellow light
